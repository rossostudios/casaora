...
export const SHORTCUTS: ShortcutEntry[] = [
  // Navigation (G-prefix sequences)
  {
    id: "go-dashboard",
    keys: ["G", "H"],
    label: { en: "Go to Dashboard", es: "Ir al Panel" },
    category: "navigation",
  },
  {
    id: "go-inbox",
  ...
  },
  {
    id: "go-chat",
    keys: ["G", "C"],
    label: { en: "Go to Chat", es: "Ir al Chat" },
    category: "navigation",
  },
  {
    id: "go-properties",
    keys: ["G", "P"],
    label: { en: "Go to Properties", es: "Ir a Propiedades" },
    category: "navigation",
  },
  {
    id: "go-units",
    keys: ["G", "U"],
    label: { en: "Go to Units", es: "Ir a Unidades" },
    category: "navigation",
  },
  {
    id: "go-reservations",
    keys: ["G", "R"],
    label: { en: "Go to Reservations", es: "Ir a Reservas" },
    category: "navigation",
  },
  {
    id: "go-operations",
    keys: ["G", "T"],
    label: { en: "Go to Operations", es: "Ir a Operaciones" },
    category: "navigation",
  },
  {
    id: "go-expenses",
    keys: ["G", "E"],
    label: { en: "Go to Expenses", es: "Ir a Gastos" },
    category: "navigation",
  },
  {
    id: "go-leases",
    keys: ["G", "L"],
    label: { en: "Go to Leases", es: "Ir a Contratos" },
    category: "navigation",
  },
  {
    id: "go-calendar",
  ...
  // Global
  {
    id: "command-palette",
    keys: ["Mod", "K"],
    label: { en: "Command palette", es: "Paleta de comandos" },
    category: "global",
  },
  {
    id: "show-help",
    keys: ["?"],
    label: { en: "Show shortcuts help", es: "Mostrar atajos" },
    category: "global",
  },
  {
    id: "new-property",
  ...
  },
  {
    id: "table-next",
    keys: ["J", "↓"],
    label: { en: "Next row", es: "Siguiente fila" },
    category: "table",
  },
  {
    id: "table-prev",
    keys: ["K", "↑"],
    label: { en: "Previous row", es: "Fila anterior" },
    category: "table",
  },
  {
    id: "table-open",
    keys: ["Enter"],
    label: { en: "Open row detail", es: "Abrir detalle" },
    category: "table",
  },
  {
    id: "table-deselect",
    keys: ["Escape"],
    label: { en: "Deselect / close detail", es: "Deseleccionar / cerrar" },
    category: "table",
  },
  {
    id: "table-select",
    keys: ["X"],
    label: { en: "Toggle row selection", es: "Seleccionar fila" },
    category: "table",
  },
  ...
  // Detail
  {
    id: "detail-close",
    keys: ["Escape"],
    label: { en: "Close sheet", es: "Cerrar panel" },
    category: "detail",
  },
  {
    id: "detail-prev",
    keys: ["["],
    label: { en: "Previous item", es: "Elemento anterior" },
    category: "detail",
  },
  {
    id: "detail-next",
    keys: ["]"],
    label: { en: "Next item", es: "Siguiente elemento" },
    category: "detail",
  },
];
