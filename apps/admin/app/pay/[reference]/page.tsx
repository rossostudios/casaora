    ...
    <div className="min-h-dvh bg-background">
      ...
      <main className="mx-auto max-w-lg px-4 py-12">
        <div className="mb-8 text-center">
          ...
          {orgName && <p className="mt-1 text-muted-foreground">{orgName}</p>}
        </div>
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            ...
            <p className="mt-1 text-center font-mono text-muted-foreground text-xs">
