    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
      ...
      <div className="group relative overflow-hidden rounded-3xl border border-border/40 bg-card p-5 shadow-[var(--shadow-floating)] transition-all hover:-translate-y-0.5 hover:border-border/60 hover:shadow-[var(--shadow-soft)]">
        ...
        <div className="mt-4 flex items-baseline gap-2">
          <p className="font-bold text-3xl text-foreground tabular-nums tracking-tight">
            {maxGuests}
          </p>
      ...
      <div className="group relative overflow-hidden rounded-3xl border border-border/40 bg-card p-5 shadow-[var(--shadow-floating)] transition-all hover:-translate-y-0.5 hover:border-border/60 hover:shadow-[var(--shadow-soft)]">
        ...
        <div className="mt-4 flex items-baseline gap-2">
          <p className="font-bold text-3xl text-foreground uppercase tracking-tight">
            {currency}
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="mt-4 flex h-[36px] items-center">
