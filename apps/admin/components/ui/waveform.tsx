...
export const LiveMicrophoneWaveform = ({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: Interactive custom waveform
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: Interactive custom waveform
    // biome-ignore lint/a11y/useAriaPropsSupportedByRole: Role is dynamic based on active state
    <div
      aria-label={
