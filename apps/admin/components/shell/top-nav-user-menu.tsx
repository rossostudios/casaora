  ...
  return (
    <PopoverRoot onOpenChange={setOpen} open={open}>
      <PopoverTrigger
        ...
        className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full bg-white/20 font-semibold text-sm text-white transition-colors hover:bg-white/30"
      >
        {account.avatarUrl ? (
          <Image
            alt="Avatar"
