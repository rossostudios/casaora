  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        <h1 className="font-medium font-serif text-4xl text-[var(--marketplace-text)] tracking-tight sm:text-5xl lg:text-6xl">
          {isEn
        ...
        >
          <label className="inline-flex h-12 flex-1 items-center gap-2 rounded-2xl border border-[#e8e4df] bg-white/80 px-4 backdrop-blur-sm sm:border-0 sm:bg-transparent">
            ...
            />
            <input
              className="h-full w-full bg-transparent text-[var(--marketplace-text)] text-sm outline-none placeholder:text-[var(--marketplace-text-muted)]/60"
          ...
          <button
            className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-casaora-gradient-warm px-6 font-medium text-sm text-white transition-opacity hover:opacity-90"
            type="submit"
          >
